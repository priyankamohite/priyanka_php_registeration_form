...
echo "<table border='1'><tr><th>First Name</th><th>Last name</th><th>Age</th><th>Gender</th><th>Email-id</th><th>Address</th><th>Country</th><th>State</th><th>City</th></tr>";
while($row = mysql_fetch_array($result)){
    echo "<tr><td>" . $row['first_name'] . "</td><td>" . $row['last_name'] . "</td><td>" . $row['age'] .
        ...
        $row['country']."</td><td>".$row['state']."</td><td>".$row['city']."</td>
        </tr>";
}
...
<!---->
<!--<td>-->
<!--    <a href="/uploads/--><?php //h($row['id']); ?><!--.jpeg">-->
<!--        <img src="/uploads/--><?php //h($row['id']); ?><!--.jpeg" alt="--><?php //h($row['title']); ?><!--"/>-->
<!--    </a>-->
<!--</td>-->
